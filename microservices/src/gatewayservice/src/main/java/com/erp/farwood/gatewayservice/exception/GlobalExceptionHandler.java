...
package com.erp.farwood.gatewayservice.exception;
...
public class GlobalExceptionHandler {
	...
	public Response<String> sqlException(SQLException ex) {
		...
		return setStatusAndMessage(HttpStatus.INTERNAL_SERVER_ERROR.value(), GatewayConstants.UNABLE_TO_PROCEED);
	}
	...
	public Response<String> serverWebInputException(ServerWebInputException ex) {
		...
		return setStatusAndMessage(HttpStatus.INTERNAL_SERVER_ERROR.value(),
				"Invalid Request, Please contact Insurance House");
	}
	...
	public Response<String> badDataExceptionHandler(BadDataException ex) {
		log.error(ex.getLocalizedMessage() + "{}", ex.toString());
		return setStatusAndMessage(HttpStatus.INTERNAL_SERVER_ERROR.value(), ex.getMessage());
	}

	@ExceptionHandler(value = ResourceNotFoundException.class)
	public Response<String> noDataFoundException(ResourceNotFoundException ex) {
		log.error(ex.getLocalizedMessage() + "{}", ex.toString());
